.class public Lcom/boohee/one/http/client/StatusClient;
.super Lcom/boohee/one/http/client/BaseJsonRequest;
.source "StatusClient.java"


# static fields
.field public static final PRODUCTION:Ljava/lang/String; = "status.boohee.com"

.field public static final QA:Ljava/lang/String; = "status.iboohee.cn"
...
.method public static delete(Ljava/lang/String;Lcom/boohee/one/http/JsonParams;Lcom/boohee/one/http/JsonCallback;Landroid/content/Context;)V
    ...
    .prologue
    .line 73
    new-instance v0, Lcom/boohee/one/http/client/StatusClient;
    ...
    invoke-static {p1}, Lcom/boohee/one/http/client/StatusClient;->putBaseParams(Lcom/boohee/one/http/JsonParams;)Lcom/boohee/one/http/JsonParams;

    move-result-object v3

    invoke-direct {v0, v1, v2, v3, p2}, Lcom/boohee/one/http/client/StatusClient;-><init>(ILjava/lang/String;Lcom/boohee/one/http/JsonParams;Lcom/boohee/one/http/JsonCallback;)V
...
.method public static get(Ljava/lang/String;Lcom/boohee/one/http/JsonCallback;Landroid/content/Context;)V
    ...
    invoke-static {p0, v0, p1, p2}, Lcom/boohee/one/http/client/StatusClient;->get(Ljava/lang/String;Lcom/boohee/one/http/JsonParams;Lcom/boohee/one/http/JsonCallback;Landroid/content/Context;)V
...
.method public static get(Ljava/lang/String;Lcom/boohee/one/http/JsonParams;Lcom/boohee/one/http/JsonCallback;Landroid/content/Context;)V
    ...
    invoke-static {v2, v3}, Lcom/boohee/one/http/client/StatusClient;->getUrlWithQueryString(Ljava/lang/String;Lcom/boohee/one/http/JsonParams;)Ljava/lang/String;
...
.method public static getAbsoluteUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/boohee/one/http/client/StatusClient;->getHostWithHttp()Ljava/lang/String;
...
.method public static getHost()Ljava/lang/String;
    ...
    .prologue
    .line 32
    sget-boolean v0, Lcom/boohee/one/http/client/StatusClient;->DEBUG:Z

    if-eqz v0, :cond_0

    const-string v0, "status.iboohee.cn"

    :goto_0
    return-object v0

    :cond_0
    const-string v0, "status.boohee.com"
